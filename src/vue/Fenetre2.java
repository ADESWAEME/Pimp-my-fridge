...
public class Fenetre2 extends JFrame {
	...
	public static ImageIcon ICON_OFF = new ImageIcon("C:/Users/Deswaeme Alexandra/git/Projet - Pimp my fridge/img/off.gif");
	public static ImageIcon ICON_YES_CONNECTE = new ImageIcon("C:/Users/Deswaeme Alexandra/git/Projet - Pimp my fridge/img/yes-connecte.gif");
	public static ImageIcon ICON_NO_CONNECTE = new ImageIcon("C:/Users/Deswaeme Alexandra/git/Projet - Pimp my fridge/img/no-connecte.gif");
	...
	public void fen() {
		...
		setTitle("Mini Frigo USB");
		
		JPanel panelTop = new JPanel();
		

		JPanel panelCenter = new JPanel();
		DataCourbe graphCourbe = new DataCourbe("Courbe des températures", "Températures");
		ChartPanel component = new ChartPanel(graphCourbe.getDCourbe());
		...
		alertCondensation.setIcon(new ImageIcon("C:/Users/Deswaeme Alexandra/git/Projet - Pimp my fridge/img/alerte.gif"));
		...
		alertTempGap.setIcon(new ImageIcon("C:/Users/Deswaeme Alexandra/git/Projet - Pimp my fridge/img/alerte.gif"));
		
		JLabel lblNewLabel_2 = new JLabel("Alexandra DESWAEME");
		...
		//lblNewLabel_1.setIcon(new ImageIcon(Fenetre.class.getResource("/fr/exia/pmf/vue/logo.png")));
	...
	//	btnFullscreen.setIcon(new ImageIcon(Fenetre2.class.getResource("/fr/exia/pmf/vue/fullscreen24.png")));
